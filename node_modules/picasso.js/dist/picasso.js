...
function scaleSequentialColor() {
  ...
  var s = scaleLinear$$1(settings, data, resources).clamp(true).interpolate(interpolateRgb);
...
function ordinal$1() {
  ...
  var ctx = { data: data, resources: resources };
  var stgns = resolveSettings$1(settings, DEFAULT_SETTINGS$5, ctx);
...
function scaleCategorical() {
  ...
  var stgns = resolveSettings$1(settings, DEFAULT_SETTINGS$4, { data: data, resources: resources });
...
var isReservedProperty$1 = function isReservedProperty(prop) {
  return ['on', 'preferredSize', 'created', 'beforeMount', 'mounted', 'resize', 'beforeUpdate', 'updated', 'beforeRender', 'render', 'beforeUnmount', 'beforeDestroy', 'destroyed', 'defaultSettings', 'data', 'settings', 'formatter', 'scale', 'chart', 'dockConfig', 'mediator', 'style', 'resolver', 'registries'].some(function (name) {
    return name === prop;
  });
};
...
var components = [box, pointMarker, pie$1, gridLine, refLine, axis, text, scrollbar, rangeBrush, rangeBrush$1, lassoBrush, labels, categoricalLegend, sequentialLegend, pointMarker$1, areaBrush];
